...
Get binary releases for Linux and macOS via the [GitHub release page](https://github.com/mhausenblas/reshifter/releases/tag/v0.3.19-alpha).
...
```
$ docker run --rm -p 8080:8080 quay.io/mhausenblas/reshifter:0.3.19
```
...
```
$ curl -s -L https://github.com/mhausenblas/reshifter/releases/download/v0.3.19-alpha/reshifter -o reshifter
$ chmod +x reshifter
$ ./reshifter
```
